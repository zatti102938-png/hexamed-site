  ...
  return (
    <section className="relative overflow-hidden bg-dark-surface py-16 text-white md:py-20">
      ...
      <div className="container relative z-10 text-center">
        <h2 className="mb-4 text-2xl font-bold text-white md:text-3xl lg:text-4xl">{headline}</h2>
        <p className="mx-auto mb-8 max-w-2xl text-lg text-white/80">{subtitle}</p>
