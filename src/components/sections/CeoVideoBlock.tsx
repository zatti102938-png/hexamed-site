        ...
        <div className="grid items-center gap-12 lg:grid-cols-2">
          <div>
            ...
            <p className="mb-6 text-lg leading-relaxed text-white/80">
              Conheça a visão do fundador da Hexamedical sobre inovação, compromisso com a qualidade e o futuro da tecnologia em diagnóstico por imagem no Brasil.
            </p>
            <div className="flex items-center gap-3 rounded-xl border border-white/10 bg-white/5 p-4">
              <div className="text-3xl font-extrabold text-primary">16+</div>
              <p className="text-sm text-white/70">Anos à frente da Hexamedical, liderando inovação em equipamentos médicos</p>
            </div>
          </div>
          <div className="relative overflow-hidden rounded-2xl border border-white/10 shadow-2xl aspect-video">
            ...
            {!isPlaying && (
              <button
                ...
                aria-label="Reproduzir vídeo do CEO Fabio Zatti"
              >
