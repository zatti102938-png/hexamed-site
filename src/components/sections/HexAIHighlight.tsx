      ...
      <div className="container relative z-10">
        <div className="grid items-center gap-12 lg:grid-cols-2">
          ...
          <div className="grid gap-4">
            {features.map((feat) => (
              <div key={feat.title} className="flex items-start gap-4 rounded-xl border border-primary-foreground/10 bg-primary-foreground/5 p-5 backdrop-blur-sm">
                ...
                <div>
                  ...
                  <p className="text-sm text-primary-foreground/70">{feat.description}</p>
                </div>
              </div>
            ))}
          </div>
